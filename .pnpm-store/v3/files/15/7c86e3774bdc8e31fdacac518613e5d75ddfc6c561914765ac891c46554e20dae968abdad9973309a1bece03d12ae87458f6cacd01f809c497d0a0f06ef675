...
var init_vlq = _chunkEBJAWNYGjs.__esm.call(void 0, {
  "node_modules/.pnpm/vlq@0.2.3/node_modules/vlq/src/vlq.js"() {
    charToInteger = {};
    integerToChar = {};
...
_chunkEBJAWNYGjs.__export.call(void 0, magic_string_es_exports, {
  Bundle: () => Bundle,
...
var init_magic_string_es = _chunkEBJAWNYGjs.__esm.call(void 0, {
  "node_modules/.pnpm/magic-string@0.22.5/node_modules/magic-string/dist/magic-string.es.js"() {
    init_vlq();
    Chunk.prototype = {
...
var require_dist = _chunkEBJAWNYGjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/rollup-plugin-hashbang@2.2.2/node_modules/rollup-plugin-hashbang/dist/index.js"(exports, module) {
    ...
    var fs2 = _interopDefault(_chunkEBJAWNYGjs.__require.call(void 0, "fs"));
    var path2 = _interopDefault(_chunkEBJAWNYGjs.__require.call(void 0, "path"));
    var MagicString = _interopDefault((init_magic_string_es(), _chunkEBJAWNYGjs.__toCommonJS.call(void 0, magic_string_es_exports)));
    function _async(f) {
      return function() {
      ...
      return {
        ...
        renderChunk(code, {
          ...
          if (!isEntry || !shebangs.has(facadeModuleId))
            return;
          outputFiles.add(file || path2.resolve(dir, fileName));
          const res = {};
          const str = new MagicString(code);
...
var loadJson = async (filepath) => {
  try {
    return _chunkEBJAWNYGjs.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var colorize = (type, data, onlyImportant = false) => {
  ...
  return _chunkOUMKCN57js.colorette_exports[color](data);
};
var makeLabel = (name, input, type) => {
  return [
    name && `${_chunkOUMKCN57js.dim.call(void 0, "[")}${name.toUpperCase()}${_chunkOUMKCN57js.dim.call(void 0, "]")}`,
      ...
      switch (type) {
        case "error": {
          if (!_worker_threads.isMainThread) {
            (_a = _worker_threads.parentPort) == null ? void 0 : _a.postMessage({
              type: "error",
        ...
        default:
          if (silent)
            return;
          if (!_worker_threads.isMainThread) {
            (_b = _worker_threads.parentPort) == null ? void 0 : _b.postMessage({
              type: "log",
              text: _util2.default.format(...args)
            });
            return;
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${_chunkOUMKCN57js.bold.call(void 0, padRight(name, maxLength))}${_chunkOUMKCN57js.green.call(void 0, 
