...
var _chunkVVG4DODSjs = require('./chunk-VVG4DODS.js');
...
var require_consola = _chunkEBJAWNYGjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkEBJAWNYGjs.__require.call(void 0, "util"));
    var e = _chunkEBJAWNYGjs.__require.call(void 0, "path");
    var t = _chunkEBJAWNYGjs.__require.call(void 0, "fs");
    var r = u(_chunkEBJAWNYGjs.__require.call(void 0, "os"));
    var n = u(_chunkEBJAWNYGjs.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkEBJAWNYGjs.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunkEBJAWNYGjs.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunkEBJAWNYGjs.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
          ...
          const result = await (postcss == null ? void 0 : postcss.default(plugins).process(contents, { ...options, from: args.path }));
          contents = result.css;
        }
        if (inject) {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkEBJAWNYGjs.localRequire.call(void 0, "svelte/compiler");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkEBJAWNYGjs.__toESM.call(void 0, require_consola());

// src/esbuild/swc.ts

var swcPlugin = ({ logger: logger2 }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkEBJAWNYGjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger2.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkEBJAWNYGjs.__require.resolve(args.path, {
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkJL7Z4YNEjs.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  const pkg = await _chunkJL7Z4YNEjs.loadPkg.call(void 0, process.cwd());
  ...
  logger2.info(format, "Build start");
  ...
  const esbuildPlugins = [
    ...
    options.tsconfigDecoratorMetadata && swcPlugin({ logger: logger2 }),
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunkEBJAWNYGjs.truthy),
      define: {
    ...
    logger2.error(format, "Build failed");
    throw error;
  }
  if (result && result.warnings && !_chunkJL7Z4YNEjs.getSilent.call(void 0, )) {
  ...
  if (result && result.outputFiles) {
    ...
    logger2.success(format, `\u26A1\uFE0F Build success in ${Math.floor(timeInMs)}ms`);
  }
  if (result.metafile) {
...
var cjsSplitting = () => {
  return {
    ...
    async renderChunk(code, info) {
      if (!this.splitting || this.options.treeshake || this.format !== "cjs" || info.type !== "chunk" || !/\.(js|cjs)$/.test(info.path)) {
        return;
      }
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkEBJAWNYGjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkOUMKCN57js.PrettyError)(
...
var isInPublicDir = (publicDir, filePath) => {
  if (!publicDir)
    return false;
  const publicPath = _chunkEBJAWNYGjs.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunkEBJAWNYGjs.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunkEBJAWNYGjs.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkOUMKCN57js.PrettyError)(
...
var normalizeOptions = async (logger2, optionsFromConfigFile, optionsOverride) => {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkOUMKCN57js.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkOUMKCN57js.PrettyError)(`Cannot find ${entry}`);
    } else {
      logger2.info("CLI", `Building entry: ${options.entry.join(", ")}`);
    }
  } else {
    Object.keys(entry).forEach((alias) => {
      const filename = entry[alias];
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkOUMKCN57js.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
    logger2.info("CLI", `Building entry: ${JSON.stringify(entry)}`);
  }
  ...
  if (tsconfig) {
    ...
    if (!options.target) {
      options.target = (_g = (_f = (_e = tsconfig.data) == null ? void 0 : _e.compilerOptions) == null ? void 0 : _f.target) == null ? void 0 : _g.toLowerCase();
    }
  } else if (options.tsconfig) {
    throw new (0, _chunkOUMKCN57js.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkJL7Z4YNEjs.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger2 = _chunkJL7Z4YNEjs.createLogger.call(void 0, item == null ? void 0 : item.name);
        const options = await normalizeOptions(logger2, item, _options);
        logger2.info("CLI", `tsup v${_chunkVVG4DODSjs.version}`);
        if (config.path) {
          logger2.info("CLI", `Using tsup config: ${config.path}`);
        }
        if (options.watch) {
          logger2.info("CLI", "Running in watch mode");
        }
        const dtsTask = async () => {
          if (options.dts) {
        ...
        const mainTasks = async () => {
          ...
          if (!((_a = options.dts) == null ? void 0 : _a.only)) {
            ...
            let depsHash = await _chunkJL7Z4YNEjs.getAllDepsHash.call(void 0, process.cwd());
            ...
            const debouncedBuildAll = _chunkEBJAWNYGjs.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkOUMKCN57js.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkEBJAWNYGjs.removeFiles.call(void 0, 
                  ["**/*", ...extraPatterns],
                  options.outDir
                );
                logger2.info("CLI", "Cleaning output folder");
              }
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunkEBJAWNYGjs.slash.call(void 0, file);
                if (options.publicDir && isInPublicDir(options.publicDir, file)) {
                  logger2.info("CLI", `Change in public dir: ${file}`);
                ...
                if (options.watch === true) {
                  if (file === "package.json" && !buildDependencies.has(file)) {
                    const currentHash = await _chunkJL7Z4YNEjs.getAllDepsHash.call(void 0, process.cwd());
                ...
                logger2.info("CLI", `Change detected: ${type} ${file}`);
                debouncedBuildAll();
              });
            };
            logger2.info("CLI", `Target: ${options.target}`);
            await buildAll();
            copyPublicDir(options.publicDir, options.outDir);
            startWatcher();
          }
